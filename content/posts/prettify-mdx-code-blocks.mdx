...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <ImageWithModal src="/images/raw-code.png" alt={"before"} aria-describedby={"before applying custom theme"} />
      </td>
      <td>
        <ImageWithModal src="/images/theme-code.gif" alt={"after"} aria-describedby={"after applying custom theme"} />
      </td>
    </tr>
  </tbody>
</table>
